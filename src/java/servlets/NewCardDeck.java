...
public class NewCardDeck extends HttpServlet {
  ...
  if ("New".equals(request.getParameter("newcarddeck"))) {
        Integer cdId = Integer.parseInt(request.getParameter("id"));
        String cdName = request.getParameter("name");
        String cdDescriptionDeck = request.getParameter("description");

        CardDeck c = new CardDeck(cdId, cdName, cdDescriptionDeck);
        
        if (ejb.insertCardDeck(c)) {
